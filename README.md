...
- Groq には無料枠があります。一般的な音声入力の使用量では十分まかなえます
  ...
  最新の上限は Groq のサイトでご確認ください（2026年9月時点で1日28,800秒＝8時間分の音声まで）

- AI補正（gpt-oss-120bモデル）にも同様に無料枠があり、通常の使用では十分まかなえます

  最新の上限は Groq のサイトでご確認ください（2026年9月時点で1日20万トークン）

  無料枠を超えた場合も、AI補正が使えなくなるだけで、Whisperの認識結果がそのまま貼り付けられます。音声入力自体は問題なく使い続けられます
